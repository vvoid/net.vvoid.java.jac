...
public class HelpJFrame extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    setTitle("Help for Jac");
    setAlwaysOnTop(true);

    jTextArea1.setColumns(20);
    jTextArea1.setRows(5);
    jTextArea1.setText("This Jac  is \"Just A Console\".\n\nUse at your own risk!\n\nLicense: AGLP!\n\nDescription:\nJac is a frontend for cmd.exe.\n\nSpecial Key Combinations:\n\nCTRL-Q: Quit the Application.\nCTRL-H: Display help.\nCTRL-R: Not yet supported...\n\nTAB: command line completion from history,\n     most recent entry first.\n     Next TAB moves moves thrug matching\n     history entries.\n     \nSHIFT-TAB: same as TAB, inverse direction.\n");
